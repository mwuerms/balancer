...
// IRQ: nRF_IRQ_GPIO_Port, nRF_IRQ_Pin, EXTI1_IRQn/EXTI2_IRQn
#define nRF_IRQ_EXTI (EXTI1_IRQn) //EXTI1_IRQn, EXTI2_IRQn
#define nrf24_hal_irq_in()	// already set
#define nrf24_hal_irq_get() LL_GPIO_IsInputPinSet(nRF_IRQ_GPIO_Port, nRF_IRQ_Pin)
//#define nrf24_hal_irq_ie_en()	HAL_NVIC_SetPriority(EXTI1_IRQn, 2, 0); HAL_NVIC_EnableIRQ(EXTI1_IRQn)
